...
GPIO.setup(GPIO.BUTTON, GPIO.IN) #pull_up_down=GPIO.PUD_DOWN)  # Button with pull>GPIO.setup(23, GPIO.OUT)  # LED
GPIO.setup(GPIO.LED, GPIO.OUT)  # LED
