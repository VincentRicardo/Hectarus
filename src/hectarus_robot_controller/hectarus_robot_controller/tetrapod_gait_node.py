...
class MyNode(Node):
    ...
    def move(self, message = Int32MultiArray):
        ...
        kit2.servo[9].angle = (data[3][5]) + data[1][5] #tibia6
        ...
        kit2.servo[12].angle = (data[3][2]) + data[2][2] #tibia5
        ...
        kit2.servo[15].angle = (data[3][8]) + data[0][8] #tibia4
        wait(0.1)
 	...
 	#coxa 3 5 maju sisanya mundur
        ...
        kit2.servo[9].angle = (data[3][5]) + data[2][5] #tibia6
        ...
        kit2.servo[15].angle = (data[3][8]) + data[1][8] #tibia4

	#femur tibia 3 turun
        kit1.servo[0].angle = 180 - data[3][8] - data[0][8] #tibia3
        kit2.servo[12].angle = (data[3][2]) + data[0][2] #tibia5
        wait(0.1)
        ...
        kit2.servo[12].angle = (data[3][2]) + data[1][2] #tibia5
        ...
        kit2.servo[15].angle = (data[3][8]) + data[2][8] #tibia4

	#femur tibia 2 turun
        kit1.servo[3].angle = 180 - data[3][2] - data[0][2] #tibia2
        kit2.servo[9].angle = (data[3][5]) + data[0][5] #tibia6
        wait(0.1)
