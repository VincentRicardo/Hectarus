...
class MyNode(Node):
    ...
    def move(self, message = Int32MultiArray):
        ...
        kit2.servo[13].angle = 90 - data[0][6] #coxa4
        
        kit2.servo[7].angle =  90 - data[1][3] #coxa6
        kit2.servo[8].angle = (180 - data[3][4]) - data[1][4] #femur6
        kit2.servo[9].angle = (180 - data[3][5]) + data[1][5] #tibia6
        
        kit1.servo[5].angle = 90 + data[1][0] #coxa2
        kit1.servo[4].angle = data[3][1] + data[1][1] #femur2
        kit1.servo[3].angle = data[3][2] - data[1][2] #tibia2

        kit2.servo[10].angle = 90 - data[2][0] #coxa5
        kit2.servo[11].angle = (180 - data[3][1]) - data[2][1] #femur5
        kit2.servo[12].angle = (180 - data[3][2]) + data[2][2] #tibia5

        kit1.servo[2].angle = 90 + data[2][6] #coxa3
        kit1.servo[1].angle = data[3][7] + data[2][7] #femur3
        kit1.servo[0].angle = data[3][8] - data[2][8] #tibia3


        #femur 1 4 turun dan tibia turun sekalian adjust ngambil kaki
        kit1.servo[6].angle = data[3][5] - data[0][5] #tibia1
        kit2.servo[15].angle = (180 - data[3][8]) + data[0][8] #tibia4
        wait(0.1)
        kit1.servo[7].angle = data[3][4] + data[0][4] #femur1
        kit2.servo[14].angle = (180 - data[3][7]) - data[0][7] #femur4
        wait(delay)
 	...
 	#coxa 3 5 maju sisanya mundur
        ...
        kit1.servo[6].angle = data[3][5] - data[1][5] #tibia1
        
        kit2.servo[7].angle =  90 - data[2][3] #coxa6
        kit2.servo[8].angle = (180 - data[3][4]) - data[2][4] #femur6
        kit2.servo[9].angle = (180 - data[3][5]) + data[2][5] #tibia6

        kit1.servo[5].angle = 90 + data[2][0] #coxa2
        kit1.servo[4].angle = data[3][1] + data[2][1] #femur2
        kit1.servo[3].angle = data[3][2] - data[2][2] #tibia2

        kit1.servo[2].angle = 90 + data[0][6] #coxa3
        kit2.servo[10].angle = 90 - data[0][0] #coxa5

        kit2.servo[13].angle = 90 - data[1][6] #coxa4
        kit2.servo[14].angle = (180 - data[3][7]) - data[1][7] #femur4
        kit2.servo[15].angle = (180 - data[3][8]) + data[1][8] #tibia4

	#femur tibia 3 turun
        kit1.servo[0].angle = data[3][8] - data[0][8] #tibia3
        kit2.servo[12].angle = (180 - data[3][2]) + data[0][2] #tibia5
        wait(0.1)
        kit1.servo[1].angle = data[3][7] + data[0][7] #femur3
        kit2.servo[11].angle = (180 - data[3][1]) - data[0][1] #femur5
        wait(delay)
        ...
        kit1.servo[6].angle = data[3][5] - data[2][5] #tibia1

        kit1.servo[5].angle = 90 + data[0][0] #coxa2
        kit2.servo[7].angle =  90 - data[0][3] #coxa6

        kit2.servo[10].angle = 90 - data[1][0] #coxa5
        kit2.servo[11].angle = (180 - data[3][1]) - data[1][1] #femur5
        kit2.servo[12].angle = (180 - data[3][2]) + data[1][2] #tibia5

        kit1.servo[2].angle = 90 + data[1][6] #coxa3
        kit1.servo[1].angle = data[3][7] + data[1][7] #femur3
        kit1.servo[0].angle = data[3][8] - data[1][8] #tibia3

        kit2.servo[13].angle = 90 - data[2][6] #coxa4
        kit2.servo[14].angle = (180 - data[3][7]) - data[2][7] #femur4
        kit2.servo[15].angle = (180 - data[3][8]) + data[2][8] #tibia4

	#femur tibia 2 turun
        kit1.servo[3].angle = data[3][2] - data[0][2] #tibia2
        kit2.servo[9].angle = (180 - data[3][5]) + data[0][5] #tibia6
        wait(0.1)
        kit1.servo[4].angle = data[3][1] + data[0][1] #femur2
        kit2.servo[8].angle = (180 - data[3][4]) - data[0][4] #femur6
        wait(delay)
