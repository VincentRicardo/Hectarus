...
def IK_tengah(maju, yaw, panjang, roll, derajat_naik_maju, geser):
    h,l = nilai_h(panjang, abs(roll), maju, derajat_naik_maju, 0, geser)
...
class MyNode(Node):
    ...
    def move(self, message = Int32MultiArray):
        ...
        base_coxa_tengah_berdiri, coxa_femur_tengah_berdiri, femur_tibia_tengah_berdiri = IK_tengah(0,0,panjang_depan_tengah,self.roll, 0, 0)
...
#            yaw = 0
            ...
            if gait == 0: #tripod
                ...
                base_coxa_tengah_kiri, coxa_femur_tengah_kiri, femur_tibia_tengah_kiri = IK_tengah(forward_kiri_tengah,(yaw), panjang_depan_tengah, self.roll, self.roll, 0)
                ...
                base_coxa_tengah_kanan, coxa_femur_tengah_kanan, femur_tibia_tengah_kanan = IK_tengah(forward_kanan_tengah,((-yaw)), panjang_depan_tengah, self.roll, self.roll, 0)
...
#                self.get_logger().info(f"Step_wave: {step_wave}")
        ...
        if message.data[2] == 11:
            angle = Int32MultiArray()
            geser = -2
            base_coxa_tengah_kiri, coxa_femur_tengah_kiri, femur_tibia_tengah_kiri = IK_tengah(0,0, panjang_depan_tengah, 0, 0, geser)
            base_coxa_tengah_kiri = base_coxa_tengah_kiri - base_coxa_tengah_berdiri
            coxa_femur_tengah_kiri = coxa_femur_tengah_kiri - coxa_femur_tengah_berdiri
            femur_tibia_tengah_kiri = femur_tibia_tengah_kiri - femur_tibia_tengah_berdiri
            ...
            base_coxa_tengah_kanan, coxa_femur_tengah_kanan, femur_tibia_tengah_kanan = IK_tengah(0,0, panjang_depan_tengah, 0, 0, -geser)
            base_coxa_tengah_kanan = base_coxa_tengah_kanan - base_coxa_tengah_berdiri
            coxa_femur_tengah_kanan = coxa_femur_tengah_kanan - coxa_femur_tengah_berdiri
            femur_tibia_tengah_kanan = femur_tibia_tengah_kanan - femur_tibia_tengah_berdiri
