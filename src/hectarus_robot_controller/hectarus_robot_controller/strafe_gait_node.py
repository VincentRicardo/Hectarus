...
class MyNode(Node):
    ...
    def strafe(self, message = Int32MultiArray):
        ...
        kit2.servo[13].angle = 80 - 30 #coxa4
        kit2.servo[7].angle = 90 + 30 #coxa6


        #femur angkat
        kit1.servo[7].angle = max(0, min((message.data[11+9] + 20), 180)) #femur1
        kit1.servo[6].angle = max(0, min((180 - message.data[12+9] + 20), 180)) #tibia1
        kit1.servo[1].angle = max(0, min((message.data[13+9] + 20), 180)) #femur3
        kit1.servo[0].angle = max(0, min((180 - message.data[14+9] + 20), 180)) #tibia3
        kit2.servo[11].angle = max(0, min((180 - message.data[9+9] - 20), 180)) #femur5
        kit2.servo[12].angle = max(0, min((message.data[10+9] - 20), 180)) #tibia5
        wait(delay)
        ...
        kit1.servo[4].angle = max(0, min((message.data[9+9] + 20), 180)) #femur2
        kit1.servo[3].angle = max(0, min((180 - message.data[10+9] + 20), 180)) #tibia2
        kit2.servo[14].angle = max(0, min((180 - message.data[13+9] - 20), 180)) #femur4
        kit2.servo[15].angle = max(0, min((message.data[14+9] - 20), 180)) #tibia4
        kit2.servo[8].angle = max(0, min((180 - message.data[11+9] - 20), 180)) #femur6
        kit2.servo[9].angle =  max(0, min((message.data[12+9] - 20), 180)) #tibia6
        wait(delay)
