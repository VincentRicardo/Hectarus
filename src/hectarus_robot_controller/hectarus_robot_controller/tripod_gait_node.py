...
class MyNode(Node):
    ...
    def move(self, message = Int32MultiArray):
        ...
        kit1.servo[6].angle = (180 - message.data[12+9]) - message.data[5] #tibia1
        kit1.servo[0].angle = (180 - message.data[14+9]) - message.data[8] #tibia3
        kit2.servo[12].angle = ((message.data[10+9]) + message.data[2+9]) #tibia5
        wait(0.1)
        ...
        kit1.servo[3].angle = (180 - message.data[10+9]) - message.data[2] #tibia2
        kit2.servo[15].angle = ((message.data[14+9]) + message.data[8+9]) #tibia4
        kit2.servo[9].angle = ((message.data[12+9]) + message.data[5+9]) #tibia6
        wait(0.1)
