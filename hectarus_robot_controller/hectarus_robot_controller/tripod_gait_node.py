...
class MyNode(Node):
    ...
    def move(self, message = Int32MultiArray):
        ...
        kit1.servo[6].angle = message.data[12] - message.data[5] #tibia1
        kit1.servo[0].angle = message.data[14] - message.data[8] #tibia3
        kit2.servo[12].angle = ((180 - message.data[10]) + message.data[2]) #tibia5
        kit1.servo[7].angle = message.data[11] + message.data[4] #femur1
        kit1.servo[1].angle = message.data[13] + message.data[7] #femur3
        kit2.servo[11].angle = ((180 - message.data[9] )- message.data[1]) #femur5
        wait(delay)
        
        #coxa femur tibia 1 3 5 balik ke posisi awal
        kit1.servo[8].angle = 90 #coxa1
        kit1.servo[7].angle = message.data[11] #femur1
        kit1.servo[6].angle = message.data[12] #tibia1

        kit1.servo[2].angle = 90 #coxa3
        kit1.servo[1].angle = message.data[13] #femur3
        kit1.servo[0].angle = message.data[14] #tibia3

        kit2.servo[10].angle = 90 #coxa5
        kit2.servo[11].angle = 180 - message.data[9] #femur5
        kit2.servo[12].angle = 180 - message.data[10] #tibia5
        ...
        kit1.servo[3].angle = message.data[10] - message.data[2] #tibia2
        kit2.servo[15].angle = ((180 - message.data[14]) + message.data[8]) #tibia4
        kit2.servo[9].angle = ((180 - message.data[12]) + message.data[5]) #tibia6
        kit1.servo[4].angle = message.data[9] + message.data[1] #femur2
        kit2.servo[14].angle = ((180 - message.data[13]) - message.data[7]) #femur4
        kit2.servo[8].angle = ((180 - message.data[11]) - message.data[4]) #femur6
        wait(delay)
        
        #coxa femur tibia 2 4 6 balik ke poisi awal
        kit1.servo[5].angle = 90 #coxa2
        kit1.servo[4].angle = message.data[9] #femur2
        kit1.servo[3].angle = message.data[10] #tibia2

        kit2.servo[13].angle = 90 #coxa4
        kit2.servo[14].angle = 180 - message.data[13] #femur4
        kit2.servo[15].angle = 180 - message.data[14] #tibia4

        kit2.servo[7].angle = 90 #coxa6
        kit2.servo[8].angle = 180 - message.data[11] #femur6
        kit2.servo[9].angle = 180 - message.data[12] #tibia6
