...
class MyNode(Node):                      
    def __init__(self):
        ...
        self.IMUAX = 0
        self.IMUAY = 0
        self.IMUX, self.IMUY, self.IMUZ, self.IMUAX, self.IMUAY = calculate_IMU_error()
    ...
    def getting_data(self, message:Int32):
        info = Int32MultiArray()
        self.send_yaw = self.yaww + (90*self.calibrate)
        info.data = [int(self.send_yaw), int(self.roll), int(message.data)]
...
#            
        ...
        self.yaww = (self.yaw * 8.115419296663)
