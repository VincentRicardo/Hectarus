...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            "tetrapod_gait_tangga_node = hectarus_robot_controller.tetrapod_gait_tangga_node:main",
            "turn_gait_node = hectarus_robot_controller.turn_gait_node:main",
            "count_time_node = hectarus_robot_controller.count_time_node:main",
            "strafe_gait_node = hectarus_robot_controller.strafe_gait_node:main"
        ],
    },
)
