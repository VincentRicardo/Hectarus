...
def nilai_h(panjang, derajat, maju, derajat_naik_maju, kurang_tinggi, geser):
    ...
    h = tibia + (math.tan(math.radians(derajat))*panjang) - kurang_tinggi #- (math.tan(math.radians(derajat_naik_maju)*maju))
...
def IK_tengah(maju, yaw, panjang, roll, derajat_naik_maju, kurang_tinggi, geser):
    h,l = nilai_h(panjang, abs(roll), maju, derajat_naik_maju, kurang_tinggi, geser)
...
def IK_depan(maju,yaw, panjang, roll, derajat_naik_maju, kurang_tinggi, geser):
    h,l = nilai_h(panjang, max(roll, 0), maju, derajat_naik_maju, kurang_tinggi, geser)
...
def IK_belakang(maju,yaw, panjang, roll, derajat_naik_maju, mundur, geser):
    h,l = nilai_h(panjang, -min(roll, 0), maju, derajat_naik_maju, 0, geser)
...
#        if self.flag == 1 and self.flag_tangga == 0:
#            self.roll = self.roll + message.data[1]
#            self.roll = max(-8, min(self.roll, 0))
...
#            base_coxa_depan_berdiri, coxa_femur_depan_berdiri, femur_tibia_depan_berdiri = IK_depan(0,0, panjang_depan_belakang, self.roll, 0, self.kurang_tinggi, 0)
#            base_coxa_belakang_berdiri, coxa_femur_belakang_berdiri, femur_tibia_belakang_berdiri = IK_belakang(0,0, panjang_depan_belakang, self.roll, 0, self.mundur, 0)
#            wait(3)
#            angle = Int32MultiArray()
#            angle.data = [90, int(coxa_femur_tengah_berdiri+35), int(femur_tibia_tengah_berdiri-45), 90, int(coxa_femur_depan_berdiri+35), int(femur_tibia_depan_berdiri-45), 80, int(coxa_femur_belakang_berdiri+35), int(femur_tibia_belakang_berdiri-45)]
#            self.publish_stop_angle.publish(angle)
#            wait(2)

        if self.temp >= 10 and self.flag_tangga == 1:
            self.mundur = 0
            self.roll = 0
#            self.roll_wave = 0
            self.flag = 1
...
#            wait(3)
        ...
        if message.data[2] == 0: #maju
            ...
            if gait == 0: #tripod
                angle = Int32MultiArray()
                base_coxa_tengah_kiri, coxa_femur_tengah_kiri, femur_tibia_tengah_kiri = IK_tengah(forward_kiri_tengah,(yaw), panjang_depan_tengah, self.roll, self.roll, self.kurang_tinggi, 0)
                ...
                base_coxa_depan_kiri, coxa_femur_depan_kiri, femur_tibia_depan_kiri = IK_depan(forward_kiri_depan_belakang,(yaw), panjang_depan_belakang, self.roll, self.roll, self.kurang_tinggi, 0)
                ...
                base_coxa_belakang_kiri, coxa_femur_belakang_kiri, femur_tibia_belakang_kiri = IK_belakang(forward_kiri_depan_belakang,(yaw), panjang_depan_belakang, self.roll, self.roll, self.mundur, 0)
                ...
                base_coxa_tengah_kanan, coxa_femur_tengah_kanan, femur_tibia_tengah_kanan = IK_tengah(forward_kanan_tengah,((-yaw)), panjang_depan_tengah, self.roll, self.roll, self.kurang_tinggi, 0)
                ...
                base_coxa_depan_kanan, coxa_femur_depan_kanan, femur_tibia_depan_kanan = IK_depan(forward_kanan_depan_belakang,((-yaw)), panjang_depan_belakang, self.roll, self.roll, self.kurang_tinggi, 0)
                ...
                base_coxa_belakang_kanan, coxa_femur_belakang_kanan, femur_tibia_belakang_kanan = IK_belakang(forward_kanan_depan_belakang,((-yaw)), panjang_depan_belakang, self.roll, self.roll, self.mundur, 0)
...
#                self.get_logger().info(f"Step_wave: {step_wave}")
                ...
                for i in range (6):
                    base_coxa_tengah_kiri, coxa_femur_tengah_kiri, femur_tibia_tengah_kiri = IK_tengah(step_wave[1],(yaw), panjang_depan_tengah, self.roll, self.roll, self.kurang_tinggi_wave, 0)
                    base_coxa_tengah_kiri = base_coxa_tengah_kiri - base_coxa_tengah_berdiri
                    coxa_femur_tengah_kiri = coxa_femur_tengah_kiri - coxa_femur_tengah_berdiri
                    femur_tibia_tengah_kiri = femur_tibia_tengah_kiri - femur_tibia_tengah_berdiri

                    base_coxa_depan_kiri, coxa_femur_depan_kiri, femur_tibia_depan_kiri = IK_depan(step_wave[0],(yaw), panjang_depan_belakang, self.roll, self.roll, self.kurang_tinggi_wave, 0)
                    base_coxa_depan_kiri = base_coxa_depan_kiri - base_coxa_depan_berdiri
                    coxa_femur_depan_kiri = coxa_femur_depan_kiri - coxa_femur_depan_berdiri
                    femur_tibia_depan_kiri = femur_tibia_depan_kiri - femur_tibia_depan_berdiri

                    base_coxa_belakang_kiri, coxa_femur_belakang_kiri, femur_tibia_belakang_kiri = IK_belakang(step_wave[0],(yaw), panjang_depan_belakang, self.roll, self.roll, self.mundur, 0)
                    base_coxa_belakang_kiri = base_coxa_belakang_kiri - base_coxa_belakang_berdiri
                    coxa_femur_belakang_kiri = coxa_femur_belakang_kiri - coxa_femur_belakang_berdiri
                    femur_tibia_belakang_kiri = femur_tibia_belakang_kiri - femur_tibia_belakang_berdiri

                    base_coxa_tengah_kanan, coxa_femur_tengah_kanan, femur_tibia_tengah_kanan = IK_tengah(step_wave[3],((-yaw)), panjang_depan_tengah, self.roll, self.roll, self.kurang_tinggi_wave, 0)
                    base_coxa_tengah_kanan = base_coxa_tengah_kanan - base_coxa_tengah_berdiri
                    coxa_femur_tengah_kanan = coxa_femur_tengah_kanan - coxa_femur_tengah_berdiri
                    femur_tibia_tengah_kanan = femur_tibia_tengah_kanan - femur_tibia_tengah_berdiri

                    base_coxa_depan_kanan, coxa_femur_depan_kanan, femur_tibia_depan_kanan = IK_depan(step_wave[2],((-yaw)), panjang_depan_belakang, self.roll, self.roll, self.kurang_tinggi_wave, 0)
                    base_coxa_depan_kanan = base_coxa_depan_kanan - base_coxa_depan_berdiri
                    coxa_femur_depan_kanan = coxa_femur_depan_kanan - coxa_femur_depan_berdiri
                    femur_tibia_depan_kanan = femur_tibia_depan_kanan - femur_tibia_depan_berdiri

                    base_coxa_belakang_kanan, coxa_femur_belakang_kanan, femur_tibia_belakang_kanan = IK_belakang(step_wave[2],((-yaw)), panjang_depan_belakang, self.roll, self.roll, self.mundur, 0)
                    base_coxa_belakang_kanan = base_coxa_belakang_kanan - base_coxa_belakang_berdiri
                    coxa_femur_belakang_kanan = coxa_femur_belakang_kanan - coxa_femur_belakang_berdiri
                    femur_tibia_belakang_kanan = femur_tibia_belakang_kanan - femur_tibia_belakang_berdiri
            ...
            if gait == 2: #tetrapod
                ...
                for i in range (3):
                    ...
                    base_coxa_belakang_kiri, coxa_femur_belakang_kiri, femur_tibia_belakang_kiri = IK_belakang(step_tetrapod[0],(yaw), panjang_depan_belakang, self.roll, self.roll, self.mundur, 0)
                    base_coxa_belakang_kiri = base_coxa_belakang_kiri - base_coxa_belakang_berdiri
                    coxa_femur_belakang_kiri = coxa_femur_belakang_kiri - coxa_femur_belakang_berdiri
                    femur_tibia_belakang_kiri = femur_tibia_belakang_kiri - femur_tibia_belakang_berdiri
                    ...
                    base_coxa_belakang_kanan, coxa_femur_belakang_kanan, femur_tibia_belakang_kanan = IK_belakang(step_tetrapod[2],((-yaw)), panjang_depan_belakang, self.roll, self.roll, self.mundur, 0)
                    base_coxa_belakang_kanan = base_coxa_belakang_kanan - base_coxa_belakang_berdiri
                    coxa_femur_belakang_kanan = coxa_femur_belakang_kanan - coxa_femur_belakang_berdiri
                    femur_tibia_belakang_kanan = femur_tibia_belakang_kanan - femur_tibia_belakang_berdiri
...
#                    self.publish_tetrapod_angle.publish(angle)
        ...
        if message.data[2] == 11:
            angle = Int32MultiArray()
            geser = -2
            base_coxa_tengah_kiri, coxa_femur_tengah_kiri, femur_tibia_tengah_kiri = IK_tengah(0,0, panjang_depan_tengah, 0, 0, 0, geser)
            base_coxa_tengah_kiri = base_coxa_tengah_kiri - base_coxa_tengah_berdiri
            coxa_femur_tengah_kiri = coxa_femur_tengah_kiri - coxa_femur_tengah_berdiri
            femur_tibia_tengah_kiri = femur_tibia_tengah_kiri - femur_tibia_tengah_berdiri

            base_coxa_depan_kiri, coxa_femur_depan_kiri, femur_tibia_depan_kiri = IK_depan(0,0, panjang_depan_belakang, 0, 0, 0, geser)
            base_coxa_depan_kiri = base_coxa_depan_kiri - base_coxa_depan_berdiri
            coxa_femur_depan_kiri = coxa_femur_depan_kiri - coxa_femur_depan_berdiri
            femur_tibia_depan_kiri = femur_tibia_depan_kiri - femur_tibia_depan_berdiri

            base_coxa_belakang_kiri, coxa_femur_belakang_kiri, femur_tibia_belakang_kiri = IK_belakang(0,0, panjang_depan_belakang, 0, 0, 0, geser)
            base_coxa_belakang_kiri = base_coxa_belakang_kiri - base_coxa_belakang_berdiri
            coxa_femur_belakang_kiri = coxa_femur_belakang_kiri - coxa_femur_belakang_berdiri
            femur_tibia_belakang_kiri = femur_tibia_belakang_kiri - femur_tibia_belakang_berdiri

            base_coxa_tengah_kanan, coxa_femur_tengah_kanan, femur_tibia_tengah_kanan = IK_tengah(0,0, panjang_depan_tengah, 0, 0, 0, -geser)
            base_coxa_tengah_kanan = base_coxa_tengah_kanan - base_coxa_tengah_berdiri
            coxa_femur_tengah_kanan = coxa_femur_tengah_kanan - coxa_femur_tengah_berdiri
            femur_tibia_tengah_kanan = femur_tibia_tengah_kanan - femur_tibia_tengah_berdiri

            base_coxa_depan_kanan, coxa_femur_depan_kanan, femur_tibia_depan_kanan = IK_depan(0,0, panjang_depan_belakang, 0, 0, 0, -geser)
            base_coxa_depan_kanan = base_coxa_depan_kanan - base_coxa_depan_berdiri
            coxa_femur_depan_kanan = coxa_femur_depan_kanan - coxa_femur_depan_berdiri
            femur_tibia_depan_kanan = femur_tibia_depan_kanan - femur_tibia_depan_berdiri

            base_coxa_belakang_kanan, coxa_femur_belakang_kanan, femur_tibia_belakang_kanan = IK_belakang(0,0, panjang_depan_belakang, 0, 0, 0, -geser)
            base_coxa_belakang_kanan = base_coxa_belakang_kanan - base_coxa_belakang_berdiri
            coxa_femur_belakang_kanan = coxa_femur_belakang_kanan - coxa_femur_belakang_berdiri
            femur_tibia_belakang_kanan = femur_tibia_belakang_kanan - femur_tibia_belakang_berdiri
